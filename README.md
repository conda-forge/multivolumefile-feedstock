...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/multivolumefile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13320&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multivolumefile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multivolumefile` can be installed with:

```
conda install multivolumefile
```

It is possible to list all of the versions of `multivolumefile` available on your platform with:
